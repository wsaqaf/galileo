Resource.delete_all
 ...
 if (Resource.where('name="Truepic"').count==0)
    r = Resource.new(:name=>'Truepic', :description=>'A pay-app. ', :tutorial=>'', :icon=>'https://truepic.com/wp-content/themes/truepic-website/images/logo-white@2x.png', :url=>'https://truepic.com/', :used_for_qs=>'GOv3F+BPywIEDxx/Igys5aRetOM=', :user_id=>2, :created_at=>Time.now.getutc, :updated_at=>Time.now.getutc)
    r.save
 else
    Resource.where('name="Truepic"').update_all(description: 'A pay-app. ',tutorial: '',icon: 'https://truepic.com/wp-content/themes/truepic-website/images/logo-white@2x.png',url: 'https://truepic.com/',:used_for_qs=>'GOv3F+BPywIEDxx/Igys5aRetOM=', :updated_at=>Time.now.getutc)
 end
 ...
 if (Resource.where('name="View DNS"').count==0)
    ...
    Resource.where('name="View DNS"').update_all(description: 'Possible to fin IP adress of the domain and who manages it, other websites hosted on the same server and the location of the server. ',tutorial: '',icon: 'https://viewdns.info/images/viewdns_logo.gif',url: 'https://viewdns.info/',:used_for_qs=>'4WkZ+Yevia+di60kyklYqhHw5GA= +dHlKzEbS1m4ebgXCkw6J7L4ovY=', :updated_at=>Time.now.getutc)
 end
 ...
 if (Resource.where('name="Wikipedias lista över svenska nyheter ordnade efter ideologi"').count==0)
    r = Resource.new(:name=>'Wikipedias lista över svenska nyheter ordnade efter ideologi', :description=>'List of swedish newspapers accoring to ideology. ', :tutorial=>'', :icon=>'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b3/Wikipedia-logo-v2-en.svg/220px-Wikipedia-logo-v2-en.svg.png', :url=>'https://sv.wikipedia.org/wiki/Lista_%C3%B6ver_svenska_tidningar_ordnade_efter_ideologi', :used_for_qs=>'3zEwscoBkWu9uo/lx1yzFz/NM2s=', :user_id=>2, :created_at=>Time.now.getutc, :updated_at=>Time.now.getutc)
    r.save
 else
    Resource.where('name="Wikipedias lista över svenska nyheter ordnade efter ideologi"').update_all(description: 'List of swedish newspapers accoring to ideology. ',tutorial: '',icon: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b3/Wikipedia-logo-v2-en.svg/220px-Wikipedia-logo-v2-en.svg.png',url: 'https://sv.wikipedia.org/wiki/Lista_%C3%B6ver_svenska_tidningar_ordnade_efter_ideologi',:used_for_qs=>'3zEwscoBkWu9uo/lx1yzFz/NM2s=', :updated_at=>Time.now.getutc)
 end
